import { Intro, Video } from "../Components/Intro";
        ...
        levels: [
            {
                ...
                dialogs: [
                    ...
                    {
                        name: "Xander ",
                        lines: "Pero la vida es efímera, el mundo es inconstante, nada perdura... Todo puede cambiar en un abrir y cerrar de ojos.",
                    },
                    {
                        name: "Xander ",
                        lines: "Aeron, mi padre, y Seraphine, mi madre, compartían un amor que parecía indestructible, hasta el final de sus días",
                    },
                    {
                        name: "Xander ",
                        lines: "Sin embargo, las tormentas suelen aparecer cuando menos las esperamos.",
                    },
                ],
            },
        ],
        ...
        levels: [
            {
                ...
                dialogs: [
                    ...
                    {
                        name: "Xander ",
                        lines: "La corrupción gubernamental es despiadada; venden los Virtual Organs sin seguro, priorizando sus ganancias por encima de la seguridad.",
                    },
                ],
            },
        ],
